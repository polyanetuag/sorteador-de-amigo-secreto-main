...
O **Sorteador de Amigo Secreto** é uma aplicação que permite que você crie uma lista para jogar amigo secreto, em que o sorteio é realizado de forma aleatória.
